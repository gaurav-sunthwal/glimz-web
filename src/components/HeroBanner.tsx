...
interface HeroBannerProps {
  ...
  onMoreInfo?: (videoId: string) => void;
}

export const HeroBanner = ({ video, onPlay, onMoreInfo }: HeroBannerProps) => {
        ...
        <div className="max-w-2xl space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4 text-white/80">
              <span className="text-lg font-medium">{video.releaseYear}</span>
