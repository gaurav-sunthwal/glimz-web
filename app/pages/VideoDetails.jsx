          ...
          <div className="max-w-3xl space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button
                ...
                variant="ghost"
                className="p-4 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20"
              >
                <Heart className={`h-6 w-6 ${isInWatchlist ? 'fill-current text-red-400' : ''}`} />
              </Button>
