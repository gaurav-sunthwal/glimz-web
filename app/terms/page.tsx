    ...
    <div className="min-h-screen py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-foreground mb-4">Terms & Policies</h1>
          <p className="text-xl text-foreground-muted">Access our terms, conditions, and policies</p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="bg-card rounded-card shadow-card p-8 border border-border">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-card-foreground mb-2">For Viewers</h2>
              <p className="text-foreground-muted">Terms and policies for content viewers</p>
            </div>
          ...
          <div className="bg-card rounded-card shadow-card p-8 border border-border">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-card-foreground mb-2">For Creators</h2>
              <p className="text-foreground-muted">Terms and policies for content creators</p>
            </div>
            <div className="space-y-3">
              <div className="text-sm text-foreground-muted mb-4">
                Available documents:
